...
\begin{lemma}\label{lem:semicirclePDFReal_zero_var}
    \leanok
    \lean{ProbabilityTheory.semicirclePDFReal_zero_var}
    \uses{def:semicirclePDFReal}
...
\begin{lemma} %instance: unsure if this should be a lemma or something else
  ...
  \uses{lem:semicircleReal_of_var_ne_zero}
  \leanok
...
\begin{lemma}
  ...
  \uses{lem:semicircleReal_of_var_ne_zero, lem:instIsProbabilityMeasuresemicircleReal} %idk if this is right
  \leanok
...
\begin{lemma}
  ...
  \uses{lem:semicircleReal_apply, lem:integrable_semicirclePDFReal, lem:semicirclePDFReal_nonneg}
  \leanok
...
\begin{lemma}
  ...
  \uses{lem:semicircleReal_zero_var, lem:semicirclePDF_zero_var, lem:semicircleReal_of_var_ne_zero, lem:measurable_semicirclePDF}
  \leanok
...
\begin{lemma}
  ...
  \uses{def:semicircleReal, lem:measurable_semicirclePDF, lem:semicirclePDF_lt_top}
  \leanok
...
\begin{lemma}
  ...
  \uses{lem:integral_semicircleReal_eq_integral_smul, lem:semicirclePDFReal_add}    %convert the statement into integral and use semicirclereal pdf...
  \leanok
...
\begin{lemma}
  ...
  \uses{lem:integral_semicircleReal_eq_integral_smul, lem:semicirclePDFReal_mul}
...
\begin{lemma}
  ...
  \lean{ProbabilityTheory.centralMoment_two_mul_semicircleReal}

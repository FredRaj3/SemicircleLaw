...
\begin{proposition}%[Equation 4.10 in \cite{Kemp2013RMTNotes}]
  ...
  \notready
  \uses{lemma:special_g_tree, lemma:special_g_edge_count, lemma:special_g_vertex_count, prop:vertex_edge_tree_equality, prop:g_bound_self_edge, prop:g_bound_large_w, def:expectation_matrix_multi_index} %uses: prop:matrix_moments_convergence for defn of t (but can replace)

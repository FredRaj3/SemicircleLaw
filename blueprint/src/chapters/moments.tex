...
\begin{lemma}
  ...
  \uses{def:g_k_ge_2,lem:equation_4.5_3,lem:Pi.prod_eq_zero_if_w_le_two,lem:prod_expectation_matrix_multi_index,prop:matrix_moments_convergence}
  $$
...
\begin{proposition}[Proposition 4.1 in \cite{Kemp2013RMTNotes}]
  ...
  \notready
  \uses{prop:trace_ev_limit_equals_t_special_g, prop:odd_case, prop:graph_catlan_number}

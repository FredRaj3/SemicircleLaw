...
\begin{lemma}
  ...
  \notready
  \uses{tree_vertex_inequality} % also include that # edges < k/2
...
\begin{proposition}
  \label{prop:odd_case}
  \notready
  \uses{lemma:vertex_bound} %equation 4.8
...
\begin{proposition}%[Proposition 4.4 in \cite{Kemp2013RMTNotes}]
  \label{prop:g_bound}
  \notready
  \uses{prop:tree_vertex_inequality} %also that things are even
...
\begin{proposition}%[Equation 4.9 in \cite{Kemp2013RMTNotes}]
  ...
  \notready
  \uses{def:big_o_with_base, prop:g_bound} %also eqn 4.6
...
\begin{proposition}%4.7.5
  \label{prop:eqn_4_7_5}
  \notready
  \uses{lemma:vertex_bound, lemma:factorial_product, lemma:eqn_trace_sum}
...
\begin{proposition}[Equation 4.8 in \cite{Kemp2013RMTNotes}]
  \label{prop:eqn_4_8}
  \notready
  \uses{prop:g_bound, prop:tree_vertex_inequality}

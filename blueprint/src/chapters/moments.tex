...
\begin{proposition}
  ...
  \notready
  \uses{def:index_pair_rel, def:graph_walk_triple_set_w_ge_two}
...
\begin{proposition}
  ...
  \uses{prop:vertex_edge_inequality, lem:simplified_var_trace_as_sum, lem:abs_expect_mul_sub_mul_expect_le, lem:g_k_k_edge_count_maximum}
  \notready

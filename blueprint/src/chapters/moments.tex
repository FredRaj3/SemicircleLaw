...
\begin{lemma}[R-2-8 : lem:expect\_mul\_eq\_prod\_expect\_edgewise\_of\_indep]
  ...
  \uses{def:def:edgeCountPair,lem:expectation_matrix_multi_index,def:graph_walk_triple_single_edges,def:graph_walk_triple_repeated_edges}
  \[
...
%---------%
%---------%
\begin{lemma}[R-2-10 : (Name unchanged since it might be merged)]
  \notready
  \label{lem:R-2-10}
...
\begin{lemma}[R-2-11 : lem:sum\_count\_edge\_pair\_eq\_length\_add\_length]
  ...
  \uses{def:edgeCountPair,def:graph_union,def:graph_multi_index,def:graph_edge_count,lem:R-2-10}
  \[
...
%---------%
%---------%
\begin{lemma}[R-2-12.2 : lem:expect\_pow\_edge\_count\_pair\_le']
  \notready
  \label{lem:expect_pow_edge_count_pair_le'}
  \uses{def:ordered_triple,def:edgeCountPair}
...
\begin{proposition}
  ...
  \uses{prop:vertex_edge_inequality, lem:simplified_var_trace_as_sum, lem:abs_expect_mul_sub_mul_expect_le}
  \notready

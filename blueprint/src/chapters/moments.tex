...
\begin{lemma}[R-2-3-5 : lem:common\_val\_prod\_of\_eq\_of\_graph\_walk\_triple\_rel]
  ...
  \uses{def:common_val_prod_of,def:matrix_multi_index,def:ordered_triple,def:graph_walk_triple_set,lem:eq_equiv_eq_expect}  
...
\begin{lemma}[R-2-4 : lem:sum\_eq\_sum\_over\_classes]
  ...
  \uses{lem:common_val_prod_eq_of_graph_walk_triple_rel,lem:variance_expansion,def:graph_walk_triple_rel,def:common_val_prod_of}
  \[
...
\begin{lemma}[R-2-8]
  ...
  \uses{def:R-2-7,lem:expectation_matrix_multi_index,def:graph_walk_triple_single_edges,def:graph_walk_triple_repeated_edges}
  \[
...
\begin{lemma}[R-2-9]
  ...
  \uses{lem:expectation_matrix_multi_index}%lem:expectation_matrix_multi_index
  \[
...
\begin{lemma}[R-2-10]
  ...
  \uses{lem:R-2-8,lem:R-2-9}%lem:R-2-8,lem:R-2-9
  \[
...
\end{lemma}
\begin{proof}
  This follows from substituting the expressions derived in Lemma \ref{lem:R-2-8} and Lemma \ref{lem:R-2-9}.
\end{proof}
%---------%
%---------%
\begin{lemma}[R-2-11]
  ...
  \uses{def:R-2-7,def:graph_union,def:graph_multi_index,def:graph_edge_count,lem:R-2-10}%def:R-2-7,def:graph_union,def:graph_multi_index,def:graph_edge_count,lem:R-2-10
  \[
...
\begin{lemma}[R-2-12.1]
  ...
  \uses{def:ordered_triple,lem:R-2-7,lem:R-2-11}%def:ordered_triple,lem:R-2-7,lem:R-2-11
...
\begin{lemma}[R-2-12,2]
  ...
  \uses{def:ordered_triple,lem:R-2-7 }%def:ordered_triple,lem:R-2-7 
...
\end{lemma}
\begin{proof}
  This follows an identical reasoning as in Lemma \ref{lem:R-2-12-1}.
\end{proof}
%---------%
%---------%
\begin{lemma}[R-2-13]
  ...
  \uses{lem:R-2-8,lem:R-2-12.1,lem:R-2-12.2}%lem:R-2-8,lem:R-2-12.1,lem:R-2-12.2
...
\end{lemma}
\begin{proof}
  By Lemma \ref{lem:R-2-8}, we have
  \[
  \mathbb{E} (Y_\mathbf{i}Y_\mathbf{j}) 
  = \prod_{e_s \in E^s_{\mathbf{i} \# \mathbf{j}}} \mathbb{E} (Y_{11}^{w_{\mathbf{i} \# \mathbf{j}}(e_s)}) \cdot \prod_{e_c \in E^c_{\mathbf{i} \# \mathbf{j}}} \mathbb{E} (Y_{12}^{w_{\mathbf{i} \# \mathbf{j}}(e_c)}).
  \]
  By Lemma \ref{lem:R-2-12.1}, there exists $n \in \mathbb{N}$ so that $\mathbb{E} (Y_{11}^{w_{\mathbf{i} \# \mathbf{j} (e)}}) \leq r_n$ for every $e \in E_{\mathbf{i} \# \mathbf{j}}$. 
  On the other hand, by Lemma \ref{lem:R-2-12.2}, there exists $m \in \mathbb{N}$ so that $\mathbb{E} (Y_{12}^{w_{\mathbf{i} \# \mathbf{j} (e)}}) \leq r_m$ for every $e \in E_{\mathbf{i} \# \mathbf{j}}$. 
  Then
  \[ \mathbb{E} (Y_\mathbf{i}Y_\mathbf{j}) 
  = \prod_{e_s \in E^s_{\mathbf{i} \# \mathbf{j}}} \mathbb{E} (Y_{11}^{w_{\mathbf{i} \# \mathbf{j}}(e_s)}) \cdot \prod_{e_c \in E^c_{\mathbf{i} \# \mathbf{j}}} \mathbb{E} (Y_{12}^{w_{\mathbf{i} \# \mathbf{j}}(e_c)})
...
\begin{lemma}[R-2-14]
  ...
  \uses{def:graph_edge_count,lem:abs_w_i_eq_k }%def:graph_edge_count,lem:abs_w_i_eq_k 
...
\end{lemma}
\begin{proof}
  This follows a similar reasoning as in Lemma \ref{lem:R-2-12.1} with the counting function $w_\mathbf{i}(\cdot)$.
\end{proof}
%---------%
%---------%
\begin{lemma}[R-2-15]
...
\begin{lemma}[R-2-16]
  ...
  \uses{lem:expectation_matrix_multi_index,lem:R-2-14,lem:R-2-15}%lem:expectation_matrix_multi_index,lem:R-2-14,lem:R-2-15
...
\begin{lemma}[R-2-17]
  ...
  \uses{lem:R-2-13,lem:R-2-16 }%lem:R-2-13,lem:R-2-16 
...
\end{lemma}
\begin{proof}
  Combining the result of Lemma \ref{lem:R-2-13} and Lemma \ref{lem:R-2-16} gives
  \[
  | \mathbb{E} (Y_\mathbf{i}Y_\mathbf{j}) -  \mathbb{E}(Y_\mathbf{i}) \mathbb{E}(Y_\mathbf{j}) |
...
\begin{proposition}
  ...
  \uses{prop:vertex_edge_inequality, lem:simplified_var_trace_as_sum, lem:R-2-17}
  \notready
...
\begin{lemma}
    \label{lem:G_leq_k}
    \notready
    \uses{lem:independent_expectation, lem:disjoint_edge_set, def:common_val_prod}  
...
\begin{lemma}
    ...
    \[ \Var\left( \frac1n\Tr(\mathbf{X}_n^k)\right) \le \sum_{(G,w,w')\in\mathcal{G}_{k,k}\atop w+w'\ge 2} \pi(G,w,w')\cdot \frac{n^{k+1}}{n^{k+2}} \le \frac1n\cdot 2M_{2k}\cdot \#\mathcal{G}_{k,k}. \]
\end{lemma}

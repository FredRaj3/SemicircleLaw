...
\begin{lemma}
  ...
  Furthermore, let $w_\mathbf{i}$ record all the non-zero exponents in $Y_\mathbf{i}$, 
  Then 
  \[
...
\begin{proof}
  ...
  On the other hand, given an edge $e \in E_\mathbf{i}$, we can interpret $w_i(e)$ as the number of times the walk $w_\mathbf{i}$ traversed $e$. 
